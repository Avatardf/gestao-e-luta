                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full bg-navy-900 border border-navy-700 text-white px-3 py-2 text-sm focus:outline-none focus:border-gold-500 transition-colors"
                          >
                            <option value={1}>GESTÃO E LUTA — Chapa 3</option>
                            <option value={2}>Chapa 1</option>
                            <option value={3}>Chapa 2</option>
                            <option value={4}>Chapa 4</option>
                          </select>
                        </div>
                        <div>
