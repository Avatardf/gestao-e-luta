...
// ─── Card de proposta ─────────────────────────────────────────────────────────
function PropostaCard({ proposta, userRating, communityData, submitting, onRate }) {
  ...
  return (
    <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-navy-700 p-6
      ...
      <div className="flex items-start gap-3 mb-4">
        <span className="text-2xl shrink-0">{proposta.icone}</span>
        <div className="flex-1 min-w-0">
          <h3 className="font-heading text-base text-slate-900 dark:text-white tracking-wide leading-tight">
            {proposta.titulo}
          </h3>
