      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs tracking-widest uppercase mt-1">Transparência · Compromisso · Resultado</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={l.href}>
                  <a href={l.href} className="text-gray-400 text-sm hover:text-gold-500 transition-colors font-heading tracking-wide">
                    {l.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 border border-navy-700 flex items-center justify-center text-gray-400 hover:text-green-400 hover:border-green-400/40 transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 border border-navy-700 flex items-center justify-center text-gray-400 hover:text-pink-400 hover:border-pink-400/40 transition-all"
              >
                <Instagram size={16} />
              </a>
              <a
                href="mailto:contato@gestaoluta.com.br"
                className="w-10 h-10 border border-navy-700 flex items-center justify-center text-gray-400 hover:text-blue-400 hover:border-blue-400/40 transition-all"
              >
                <Mail size={16} />
              </a>
            </div>
