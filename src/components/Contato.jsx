...
export default function Contato() {
  ...
  return (
    <section id="contato" className="py-24 bg-slate-50 dark:bg-navy-900">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-navy-950 border border-slate-200 dark:border-navy-700 text-slate-900 dark:text-white px-4 py-3 text-sm focus:outline-none focus:border-gold-500 transition-colors placeholder-slate-400 dark:placeholder-navy-600"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white dark:bg-navy-950 border border-slate-200 dark:border-navy-700 text-slate-900 dark:text-white px-4 py-3 text-sm focus:outline-none focus:border-gold-500 transition-colors placeholder-slate-400 dark:placeholder-navy-600 resize-none"
                  />
                </div>
